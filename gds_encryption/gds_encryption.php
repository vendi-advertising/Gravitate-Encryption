...
class GDS_Encryption_Class
{
	...
	public function custom_submenu_page_callback()
	{
		...
		<div class="wrap">
		      ...
		      <br/>
		      <?php if($sent_keys){?> <div class="updated"><p>Your Key(s) have been Emailed to You! Check your spam folder if you don't see them.</p></div> <?php } ?>
		      <?php if($update && $update !== 'error'){?> <div class="updated"><p>Settings Saved Successfully!</p></div> <?php } ?>
		      <?php if($update && $update === 'error'){?> <div class="error"><p>Error Saving Settings to Database.  Please try again.</p></div> <?php } ?>
		        ...
		        <table class="form-table">
		          <tbody>
		            <tr valign="top">
		              ...
		              <td><fieldset>
		                  ...
		                  <label for="encryption_weak">
		                    <input type="radio"<?php if($form_fields['encription_type'] == 'encryption_weak'){?> checked="checked"<?php } ?> value="encryption_weak" id="encryption_weak" name="encription_type" onclick="gds_encryption_update_form();" />
		                    Weak Encryption</label> <span style="color:gray;"> ( Weak Encryption, but useful if other methods are unavailable. )</span><br/>
		                  <label for="encryption_none">
		                    <input type="radio"<?php if($form_fields['encription_type'] == 'encryption_none'){?> checked="checked"<?php } ?> value="encryption_none" id="encryption_none" name="encription_type" onclick="gds_encryption_update_form();" />
					...
					<tr id="private_key_container" valign="top">
					  <th scope="row"><label for="private_key">Private Key<br/><br/>LEAVE THIS BLANK if you plan on decrypting from another Application</label></th>
					  <td>
					  	<textarea id="private_key" name="private_key" style="width: 520px; height: 300px;"><?php echo $form_fields['private_key'];?></textarea>
					  	<?php if($openssl_available){?><a class="button" href="javascript:gds_encryption_generate_keys(1);">Auto Create Keys</a><?php } ?>
					  </td>
					</tr>
					...
					<tr id="encrypt_all_gravity_forms_container" valign="top">
					  ...
					  <td><fieldset>
					      ...
					      <label for="encrypt_all_gravity_forms">
					        <input type="checkbox"<?php if($form_fields['encrypt_all_gravity_forms']){?> checked="checked"<?php } ?> value="1" id="encrypt_all_gravity_forms" name="encrypt_all_gravity_forms" onchange="gds_encryption_update_form();" />
					...
					<tr valign="top">
					  ...
					  <td><fieldset>
					      ...
					      <label for="use_remote_storage">
					        <input type="checkbox"<?php if($form_fields['use_remote_storage']){?> checked="checked"<?php } ?> value="1" id="use_remote_storage" name="use_remote_storage" onchange="gds_encryption_update_form();" />
					...
					<tr id="remote_database_removal_container" valign="top">
					  ...
					  <td><fieldset>
					      ...
					      <label for="remote_database_removal">
					        <input type="checkbox"<?php if($form_fields['remote_database_removal']){?> checked="checked"<?php } ?> value="1" id="remote_database_removal" name="remote_database_removal" />
					...
					<tr id="remote_database_host_container" valign="top">
					  ...
					  <td>
					  	<input type="text" id="remote_database_host" name="remote_database_host" maxlength="200" value="<?php echo $form_fields['remote_database_host'];?>" />
					  </td>
					</tr>
					<tr id="remote_database_port_container" valign="top">
					  <th scope="row"><label for="remote_database_port">Remote Database Port</label></th>
					  <td>
					  	<input type="text" id="remote_database_port" name="remote_database_port" maxlength="10" value="<?php echo $form_fields['remote_database_port'];?>" />
					  </td>
					</tr>
					<tr id="remote_database_name_container" valign="top">
					  <th scope="row"><label for="remote_database_name">Remote Database Name</label></th>
					  <td>
					  	<input type="text" id="remote_database_name" name="remote_database_name" maxlength="200" value="<?php echo $form_fields['remote_database_name'];?>" />
					  </td>
					</tr>
					<tr id="remote_database_username_container" valign="top">
					  ...
					  <td>
					  	<input type="text" autocomplete="off" id="remote_database_username" name="remote_database_username" maxlength="200" value="<?php echo $form_fields['remote_database_username'];?>" />
					  </td>
					</tr>
					<tr id="remote_database_password_container" valign="top">
					  ...
					  <td>
					  	<input type="password" autocomplete="off" id="remote_database_password" name="remote_database_password" maxlength="200" value="<?php echo $form_fields['remote_database_password'];?>" />
					  </td>
					</tr>
					<tr id="remote_database_table_container" valign="top">
					  ...
					  <td>
					  	<input type="text" autocomplete="off" id="remote_database_table" name="remote_database_table" maxlength="200" value="<?php echo $form_fields['remote_database_table'];?>" />
					  </td>
					</tr>
					<tr id="remote_database_table_id_container" valign="top">
					  ...
					  <td>
					  	<input type="text" autocomplete="off" id="remote_database_table_id" name="remote_database_table_id" maxlength="200" value="<?php echo $form_fields['remote_database_table_id'];?>" />
					  </td>
					</tr>
					<tr id="remote_database_table_parent_id_container" valign="top">
					  ...
					  <td>
					  	<input type="text" autocomplete="off" id="remote_database_table_parent_id" name="remote_database_table_parent_id" maxlength="200" value="<?php echo $form_fields['remote_database_table_parent_id'];?>" />
					  </td>
					</tr>
					<tr id="remote_database_table_value_container" valign="top">
					  ...
					  <td>
					  	<input type="text" autocomplete="off" id="remote_database_table_value" name="remote_database_table_value" maxlength="200" value="<?php echo $form_fields['remote_database_table_value'];?>" />
					  </td>
					</tr>
		      ...
		      <h2 id="enc_test">Encryption Test <a class="button" href="?page=gds-encryption-custom-submenu-page&encryption_test=1&rand=<?php echo time();?>#enc_test">Run Test</a></h2>
		      ...
		      <label style="display: inline-block;width: 100px;font-weight: bold;">Encrypted Text:</label><?php echo GDS_Encryption_Class::encrypt($encryption_test);?><br/><br/>
		      <label style="display: inline-block;width: 100px;font-weight: bold;">Decrypted Text:</label><?php echo GDS_Encryption_Class::decrypt(GDS_Encryption_Class::encrypt($encryption_test));?><br/>
		      <?php } ?>
		      </div>
		      <?php } ?>
...
function gds_encryption_custom_submenu_page()
{
	...
	{
		add_submenu_page( 'options-general.php', 'Gravitate Encryption', 'Gravitate Encryption', 'manage_options', 'gds-encryption-custom-submenu-page', 'gds_encryption_custom_submenu_page_callback' );
	}
}
